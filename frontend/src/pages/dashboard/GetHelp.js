  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>Location: Quarter 6, Linh Trung w., Thu Duc City, Ho Chi Minh City</li>
        <li>Phone: (028) 37244270 ext. 3232</li>
        <li>Fax: (028) 37244271</li>
        <li>Email: cse@hcmiu.edu.vn</li>
        <li>Working Hours: 8am-5pm</li>
      </ul>
      <h2>Lecturer Responsible for Student internship and job assistance system</h2>
      <ul>
        <li>Name: MSc. Pham Quoc Son Lam</li>
        <li>
          Location: Room 610, International University. Block 6, Linh Trung Ward, Thu Duc District, HCM City, Vietnam
        </li>
