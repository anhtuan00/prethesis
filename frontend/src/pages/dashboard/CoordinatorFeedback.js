...
let coordinatorFeedback = [
  {
    ...
    studentFeedback: "passionate student",
  ...
  },
  {
    ...
    internshipPosition: "Backend Developer",
    courseFeedback: "All good",
    studenFeedback: "passionate student",
    companyFeedback: "Good company",
  },
];

function CoordinatorFeedback() {
  const [data, setData] = useState(coordinatorFeedback);
  const columns = [
    ...
    { title: "Company Feedback", field: "companyFeedback" },
  ];
