...
let manageInternshipReport = [
  {
    _id: 1,
    studentName: "Mehetabel O'Hannigan",
    studentId: "ITITIU18123",
    companyName: "FPT Software",
    internshipReport: "example.com/file.pdf",
  },
  {
    _id: 2,
...
function ManageInternshipReport() {
  const [data, setData] = useState(manageInternshipReport);
  const columns = [
  ...
  return (
    <div>
      <MaterialTable
        title="Manage Internship Report"
        columns={columns}
        data={data}
        icons={tableIcons}
        editable={{
...
export default ManageInternshipReport;
